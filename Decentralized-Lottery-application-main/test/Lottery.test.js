const assert = require('assert');  //it's used to run and organize tests.
const ganache = require('ganache');    //Used to deploy and test contracts instantly. Local Ethereum Blockchain Simulator
const { Web3 } = require('web3'); //deploy smart contracts
